...
class FrancaSomeIPGeneratorExtensions {
    ...
    def getSomeIPLicenseHeader() {
        return FPreferencesSomeIP::instance.getPreference(PreferenceConstantsSomeIP::P_LICENSE_SOMEIP, PreferenceConstantsSomeIP.DEFAULT_LICENSE_SOMEIP)
    }
...
//                deploymentType += (_type.eContainer as FModelElement).getElementName(_interface, true) + "_::"
//            } else if (_interface != null) {
//                deploymentType += _interface.getElementName(_interface, true) + "_::"
//            }
//        } else if (_interface != null) {
//            deploymentType += _interface.getElementName(_interface, true) + "_::"
//        }
    ...
    ////////////////////////////////////////
    def String getDeploymentName(FTypedElement _typedElement, FModelElement _element, FInterface _interface,
    ...
    def dispatch String getDeploymentName(FTypeDef _typeDef, FTypeCollection _interface, PropertyAccessor _accessor) {
        return _typeDef.actualType.getDeploymentName(_interface, _accessor)
    }

    def dispatch String getDeploymentName(FTypeRef _typeRef, FTypeCollection _interface, PropertyAccessor _accessor) {
        if (_typeRef.derived != null) {
    ...
    def dispatch String getDeploymentName(FType _type, FTypeCollection _interface, PropertyAccessor _accessor) {
    ...
    def dispatch String getDeploymentName(FBasicTypeId _typeId, FTypeCollection _interface, PropertyAccessor _accessor) {
        return ""
    }
    ...
    def String getDeployments(FBroadcast _broadcast, FInterface _interface,
        ...
        return "std::make_tuple(" +
            _broadcast.outArgs.map[getDeploymentRef(it.array, _broadcast, _interface, _accessor)].join(", ") + ")"
    }
    ...
    def String getDeployments(FMethod _method, FInterface _interface,
        ...
        if (_withOutArgs) {
            outArgsDeployments = _method.outArgs.map[getDeploymentRef(it.array, _method, _interface, _accessor)].
                join(", ")
            if (_method.hasError) {
    ...
    def dispatch Set<String> getDeploymentInputIncludes(FStructType _struct, PropertyAccessor _accessor) {
        ...
        while(itsStruct != null) {
            for (e : itsStruct.elements) {
                ...
                if (etype != null) {
                    ret.addAll(etype.getDeploymentInputIncludes(_accessor))
                }
            }
        ...
        for (x : _interface.broadcasts) {
            for (y : x.outArgs) {
                if (y.type.derived != null) {
                    ret.addAll(y.type.derived.getDeploymentInputIncludes(_accessor))
                }
            }
