...
int main() {
    CommonAPI::Runtime::setProperty("LogContext", "E02SA");
    CommonAPI::Runtime::setProperty("LogApplication", "E02SA");
    ...
    std::shared_ptr<MergedInterfaceStubImplA> myService = std::make_shared<MergedInterfaceStubImplA>();
